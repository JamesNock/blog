...
main_content:
  ...
  -
    ...
    content:
      -
        type: text
        text: "Until a ticket has this level of detail, it's not ready for engineering. Developers shouldn't be expected to start work until the scope is clear. A well-defined ticket allows the whole team to understand:"
  -
    type: bulletList
    content:
      -
