...
main_content:
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: ' to exit nano and hit enter to save. Caddy will magically generate the SSL certificate for your site and it will start working very soon. You can spy on progress by running '
      -
        type: text
        marks:
          -
